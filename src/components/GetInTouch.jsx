...
const GetInTouch = () => {
  return (
    <div
      ...
      className="mb-[120px] mx-auto bg-dblue max-w-[1360px] w-full  gap-5 md:gap-0  lg:h-[210px]  rounded-lg bg-contain bg-center bg-no-repeat flex   flex-col  lg:flex-row items-center justify-between p-[50px]"
    >
